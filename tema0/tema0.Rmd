...
La base de datos `mtcars` de R contiene información extraída de la *1974 Motor Trend US magazine* acerca de 10 aspectos de diseño y rendimiento de 32 vehículos. La variable `am` se refiere a la transmisión (0 = automática, 1 = manual)
...
2. **Organización**: almacenar datos de manera consistente con el análisis.
...
* Web del curso: [https://cunef-aeinf.github.io/inf-26-27/](https://cunef-aeinf.github.io/inf-26-27/)
...
* **Convocatoria Extraordinaria**: Examen Extraordinario Final (60%) + Evaluación continua. La nota de la continua para la convocatoria extraordinaria será la mejor entre:

  - Evaluación continua
  - Media ponderada de la evaluación continua y el examen ordinario final
