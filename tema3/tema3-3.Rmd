...
* Determinar qué strings cumplen el patrón. 
...
Vamos a aprender a jugar con patrones muy sencillos. Primero, coincidencia 
...
Para trabajar con fechas y horas usamos `lubridate` que **NO** es parte de tidyverse.
...
```{r}
ymd("2020-01-1") + months(1)   # "2020-02-01" (respeta el calendario)
ymd("2020-01-1") + dmonths(1)  # "2020-01-31" (30.44 días exactos)
```
