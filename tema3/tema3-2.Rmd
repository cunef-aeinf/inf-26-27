...
* Aprenderemos una forma consistente de organizar los datos en R
...
* Por defecto, separa cuando encuentra un carácter no alfanumérico.
...
* `semi_join(x,y)`: mantiene todas las observaciones de `x` que tienen pareja en
`y`
