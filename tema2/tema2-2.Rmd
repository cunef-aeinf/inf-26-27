...
**NOTA**: los verbos no modifican el data frame. Para guardar el output como un nuevo dataframe
```{r, eval=F}
...
Seleccionemos país, año y esperanza de vida y ordenemos en orden **decreciente** de esperanza de vida
...
3. Por último, el resultado del select pasa a `arrange`
...
Ejemplo: seleccionar países de América que en el 2007 tuvieran esperanza de vida superior a 77 o un PIB per cápita inferior a 4000
