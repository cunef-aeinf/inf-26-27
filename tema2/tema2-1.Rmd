...
# Visualización: Visualizando la relación entre PIB per cápita y esperanza de vida
...
* El `mapping`  define cómo las variables son mapeadas a propiedades visuales del gráfico.
...
¿Cómo describirías la relación entre PIB per Cápita y esperanza de vida?
...
size          | pasos discretos         | mapeo lineal entre variable y radio
...
- .vocab[Variables numéricas] pueden ser .vocab[continuas] o .vocab[discretas] 
    - *altura* es ?
...
## ¿Cómo podemos describir datos numéricos univariantes?

- .vocab[Forma:]
    - asimetría: simétrico, asimétrico a la derecha, asimétrico a la izquierda
...
## Datos bivariantes: continuo - categórico
...
---
## Datos bivariantes: continuo - continuo
...
---
## Datos bivariantes: categórico - categórico
