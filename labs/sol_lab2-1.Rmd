...
- `plastic_waste_per_cap`: Cantidad de residuos per cápita de plástico en kg/día
...
- `coastal_pop`: Número de individuos que viven en o cerca de la costa
...
Visualiza la distribución de la cantidad de residuos de plástico per cápita por continente, usando distintos histogramas para cada continente.
...
¿Observas algún patrón que distinga la distribución de la cantidad de residuos de plástico de continentes desarrollados y en vías de desarrollo?
