...
Bienvenido al sitio web de la asignatura de **Análisis y Explotación de la Información** del primer cuatrimestre del curso 2026-2027 en CUNEF Universidad. En este sitio web encontrarás el material y los laboratorios que usaremos durante el curso. La página se actualizará con frecuencia durante el cuatrimestre, así que acostúmbrate a visitarla a menudo.
...
<!-- PENDIENTE DE PUBLICAR: descomentar cada tema a medida que avance el curso.
...
### Lab 2.1 - Visualización
  - [Ejercicios](./labs/lab2-1.html)


### Lab 2.2 - Transformación
  - [Ejercicios](./labs/lab2-2.html)


<!-- PENDIENTE DE PUBLICAR: descomentar cada laboratorio a medida que avance el curso.

### Lab 3.1 - Importación
  - [Ejercicios](./labs/lab3-1.html)


### Lab 3.2 - Data Wrangling
  - [Ejercicios](./labs/lab3-2.html)


### Lab 3.3 - Strings, Factores y Fechas
  - [Ejercicios](./labs/lab3-3.html)
